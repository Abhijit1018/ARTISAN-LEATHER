...
export default function AboutPage() {
    return (
        <>
            <section className="shop-hero" style={{ padding: '160px 0 100px' }}>
                <motion.div
                    className="container"
            ...
            <section className="section-padding" style={{ backgroundColor: 'var(--color-cream)' }}>
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4xl)', alignItems: 'center' }}>
                        ...
                        >
                            <h2 style={{ fontSize: 'clamp(2rem, 4vw, 3rem)', color: 'var(--color-secondary)', marginBottom: 'var(--space-lg)' }}>
                                Founded on <span className="gold-accent">Tradition</span>
                            </h2>
                            <p style={{ fontSize: '1.1rem', color: 'var(--color-gray-600)', marginBottom: 'var(--space-md)', lineHeight: '1.8' }}>
                            ...
                            <p style={{ fontSize: '1.1rem', color: 'var(--color-gray-600)', lineHeight: '1.8' }}>
                        ...
                        <motion.div
                            style={{ position: 'relative', height: '600px', borderRadius: 'var(--radius-lg)', overflow: 'hidden', boxShadow: 'var(--shadow-xl)' }}
            ...
            <section className="section-padding" style={{ backgroundColor: 'var(--color-secondary)', color: 'var(--color-white)' }}>
                <div className="container">
                    <motion.div
                        ...
                        transition={{ duration: 0.6 }}
                    >
                        <h2 style={{ fontSize: '2.5rem', marginBottom: 'var(--space-lg)' }}>Our Commitment to the Earth</h2>
